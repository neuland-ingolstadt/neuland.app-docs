...
Wenn du einen Fehler entdeckst, eine Funktion anregen möchtest oder Hilfe mit der App benötigst, lass es uns bitte wissen. Alle Support-Optionen findest du auf unserer [Fehlerbehebungs](/docs/app/troubleshoot)- und [Feedback](/docs/app/feedback)-Seite.
...
Wir suchen immer Hilfe bei Dokumentation, Übersetzungen, Design und Tests. Wenn du Interesse hast, in einem dieser Bereiche mitzuarbeiten, lass es uns bitte über die Kontaktoptionen auf unserer [Feedback-Seite](/docs/app/feedback) wissen.

### Entwickler

Wir verwenden GitHub, um unseren Code zu verwalten und Issues zu verfolgen. Bitte sieh dir den [Entwicklungssetup-Guide](/docs/contribute/setup) für weitere Informationen dazu an, wie du zum Projekt beitragen kannst. Eine Liste offener [Issues](https://github.com/neuland-ingolstadt/neuland.app-native/issues), an denen du arbeiten kannst, findest du dort.
...
Wenn du eine Sicherheitslücke in Neuland Next entdeckst, melde sie uns bitte umgehend. Verwende die Funktion [GitHub-Sicherheitsberatungen](https://github.com/neuland-ingolstadt/neuland.app-native/security/advisories/new) um uns die Sicherheitslücke zu melden. Oder du kannst uns eine E-Mail an [security@neuland-ingolstadt.de](mailto:security@neuland-ingolstadt.de) senden.
Wir nehmen Sicherheit sehr ernst und werden mit dir zusammenarbeiten, um das Problem schnell zu beheben.
