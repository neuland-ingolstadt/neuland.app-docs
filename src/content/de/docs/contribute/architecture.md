...
- **neuland.app-docs**: Die Landing Page und Dokumentation für das Projekt. Erstellt mit Next.js und Nextra, um eine nahtlose Erfahrung für Nutzer zu bieten, um mehr über das Projekt und seine Funktionen zu erfahren.
