...
export const members = [
  {
    avatar: 'https://github.com/roberteggl.png',
    name: 'Robert Eggl',
    title: 'Gründer & Projektleiter Neuland Next (bis 2026) & Entwickler',
    links: [
      { icon: 'github', link: 'https://github.com/roberteggl' },
      { icon: 'linkedin', link: 'https://www.linkedin.com/in/roberteggl/' },
      { icon: 'website', link: 'https://eggl.dev/' },
    ]
  },
  {
